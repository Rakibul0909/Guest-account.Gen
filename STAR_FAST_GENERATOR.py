...
BASE_FOLDER = os.path.join(CURRENT_DIR, "STAR")
...
hex_data = "UFJFTUlVTSBBQ0NPVU5UIEdFTkVSQVRPUiDimKogQnkgU1RBUl9HTVIgfCBOb3QgRm9yIFNhbGUg8J+Tqw=="
...
def save_couples_account(account1, account2, reason, is_ghost=False):
    try:
        ...
        couples_entry = {
            ...
            'reason': reason,
            'region': "STAR" if is_ghost else account1.get('region', 'UNKNOWN'),
...
def main_menu():
    while True:
        ...
        print(f"{get_random_color()}{Colors.BRIGHT}🎮 Welcome to STAR Account Generator{Colors.RESET}")
